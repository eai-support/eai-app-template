...
3. Harden workflow inputs, every governed path and output component, source-only configuration/provenance hashing, image-context construction, and artifact upload.
