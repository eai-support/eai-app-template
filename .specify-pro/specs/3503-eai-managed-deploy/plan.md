...
3. Harden workflow inputs, every governed path and output component, complete configuration/provenance hashing, no-follow entry-by-entry image-context construction, and artifact upload.
